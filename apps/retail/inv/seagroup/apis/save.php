...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_seagroup';
		$primarykey = 'seagroup_id';
		...
		try {
			...
			$obj->seagroup_id = strtoupper($obj->seagroup_id);
			$obj->seagroup_name = strtoupper($obj->seagroup_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'seagroup_id', 'seagroup_name', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
