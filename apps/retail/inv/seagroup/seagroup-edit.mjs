...
const obj = {
	txt_seagroup_id: $('#pnl_edit-txt_seagroup_id'),
	txt_seagroup_name: $('#pnl_edit-txt_seagroup_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_seagroup_id,
		autoid: false,
		logview: 'mst_seagroup',
		btn_edit: btn_edit,
		btn_save: btn_save,
