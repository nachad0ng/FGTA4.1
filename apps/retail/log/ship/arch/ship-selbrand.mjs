...
const btn_load = $('#pnl_selbrand-btn_load')
const tbl_list = $('#pnl_selbrand-tbl_list')
const txt_search = $('#pnl_selbrand-txt_search')
...
function grd_list_rowclick(tr, ev) {
	...
	$ui.mask('setdata')
	$ui.getPages().show('pnl_edit')
	$ui.getPages().ITEMS['pnl_edit'].handler.txt_brand_id_select(record.brand_id, record.brand_name)
