...
const btn_load = $('#pnl_selsea-btn_load')
const tbl_list = $('#pnl_selsea-tbl_list')
const txt_search = $('#pnl_selsea-txt_search')
...
function grd_list_rowclick(tr, ev) {
	...
	$ui.mask('setdata')
	$ui.getPages().show('pnl_edit')
	$ui.getPages().ITEMS['pnl_edit'].handler.txt_sea_id_select(record.sea_id, record.sea_name)
