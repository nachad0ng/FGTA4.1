...
const obj = {
	txt_logshipcostsrc_id: $('#pnl_edit-txt_logshipcostsrc_id'),
	txt_logshipcostsrc_name: $('#pnl_edit-txt_logshipcostsrc_name'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_logshipcostsrc_id,
		autoid: false,
		btn_edit: btn_edit,
		btn_save: btn_save,
...
async function preLoadData(){
	...
	let apiurl = $ui.apis.partner_loaddata
	try {
		let result = await $ui.apicall(apiurl, args)
		// console.log(result.records)
		obj.cbo_partner_id.combobox('loadData', result.records)
	}catch(err){
...
function form_idsetup(options) {
	var objid = obj.txt_logshipcostsrc_id
