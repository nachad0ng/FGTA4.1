	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'brand_name', 'brand_nameshort', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'bussinesstype_name' => \FGTA4\utils\SqlUtility::Lookup($data->bussinesstype_id, $this->db, 'mst_bussinesstype', 'bussinesstype_id', 'bussinesstype_name'),
