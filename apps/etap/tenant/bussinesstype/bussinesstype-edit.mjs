...
const obj = {
	txt_bussinesstype_id: $('#pnl_edit-txt_bussinesstype_id'),
	txt_bussinesstype_name: $('#pnl_edit-txt_bussinesstype_name'),
	txt_bussinesstype_descr: $('#pnl_edit-txt_bussinesstype_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_bussinesstype_id,
		autoid: false,
		logview: 'mst_bussinesstype',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_bussinesstype_id
