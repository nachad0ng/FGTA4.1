	...
	public function execute($options) {
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"locpic_id" => " locpic_id = :locpic_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_locpic', [
				'locpic_id', 'locpic_name', 'locpic_resp', 'locpic_email', 'locpic_phone', 'loc_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
