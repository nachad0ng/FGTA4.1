	...
	public function execute($options) {
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"companybrand_id" => " companybrand_id = :companybrand_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('mst_companybrand', [
				'companybrand_id', 'brand_name', 'brand_nameshort', 'brand_isdisabled', 'company_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
