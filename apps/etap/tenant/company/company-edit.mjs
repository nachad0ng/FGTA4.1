...
const obj = {
	txt_company_id: $('#pnl_edit-txt_company_id'),
	txt_company_name: $('#pnl_edit-txt_company_name'),
	txt_company_address: $('#pnl_edit-txt_company_address'),
	txt_company_city: $('#pnl_edit-txt_company_city'),
	txt_company_telp: $('#pnl_edit-txt_company_telp'),
	txt_company_email: $('#pnl_edit-txt_company_email'),
	txt_company_npwp: $('#pnl_edit-txt_company_npwp'),
	chk_company_isdisabled: $('#pnl_edit-chk_company_isdisabled')
}
