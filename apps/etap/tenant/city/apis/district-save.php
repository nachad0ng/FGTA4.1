...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->district_name = strtoupper($obj->district_name);
			...
			try {
				...
				$header_table = 'mst_city';
				$header_primarykey = 'city_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'district_name', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
