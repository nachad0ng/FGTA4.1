...
const obj = {
	...
	txt_jabatan_name: $('#pnl_edit-txt_jabatan_name'),
	txt_jabatan_nameshort: $('#pnl_edit-txt_jabatan_nameshort'),
	txt_jabatan_descr: $('#pnl_edit-txt_jabatan_descr'),
	txt_jabatan_code: $('#pnl_edit-txt_jabatan_code'),
