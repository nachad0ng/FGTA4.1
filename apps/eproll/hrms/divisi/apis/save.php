...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->divisi_name = strtoupper($obj->divisi_name);
			$obj->divisi_namereport = strtoupper($obj->divisi_namereport);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'divisi_name', 'divisi_namereport', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
