...
const obj = {
	txt_kontrak_id: $('#pnl_edit-txt_kontrak_id'),
	txt_kontrak_name: $('#pnl_edit-txt_kontrak_name'),
	txt_kontrak_nameshort: $('#pnl_edit-txt_kontrak_nameshort'),
	txt_kontrak_code: $('#pnl_edit-txt_kontrak_code'),
	txt_kontrak_descr: $('#pnl_edit-txt_kontrak_descr'),
	chk_kontrak_isdisabled: $('#pnl_edit-chk_kontrak_isdisabled')
}
