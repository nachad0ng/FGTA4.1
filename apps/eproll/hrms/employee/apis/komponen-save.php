...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_empkomp';
		$primarykey = 'empkomp_id';
		...
		try {
			...
			try {
				...
				$header_table = 'mst_employee';
				$header_primarykey = 'employee_id';
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'komp_name' => \FGTA4\utils\SqlUtility::Lookup($data->komp_id, $this->db, 'mst_komp', 'komp_id', 'komp_name'),
