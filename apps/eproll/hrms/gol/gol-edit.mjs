...
const obj = {
	txt_gol_id: $('#pnl_edit-txt_gol_id'),
	txt_gol_name: $('#pnl_edit-txt_gol_name'),
	txt_gol_descr: $('#pnl_edit-txt_gol_descr'),
	txt_gol_code: $('#pnl_edit-txt_gol_code'),
	txt_gol_level: $('#pnl_edit-txt_gol_level'),
	chk_gol_isdisabled: $('#pnl_edit-chk_gol_isdisabled')
}
