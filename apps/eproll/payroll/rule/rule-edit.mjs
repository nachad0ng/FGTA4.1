...
const obj = {
	txt_rule_id: $('#pnl_edit-txt_rule_id'),
	txt_rule_name: $('#pnl_edit-txt_rule_name'),
	txt_rule_code: $('#pnl_edit-txt_rule_code'),
	txt_rule_operator: $('#pnl_edit-txt_rule_operator'),
	chk_rule_isdisabled: $('#pnl_edit-chk_rule_isdisabled')
}
