...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->rule_name = strtoupper($obj->rule_name);
			$obj->rule_code = strtoupper($obj->rule_code);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'rule_name', 'rule_code', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
