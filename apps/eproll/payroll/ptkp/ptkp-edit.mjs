...
const obj = {
	txt_ptkp_id: $('#pnl_edit-txt_ptkp_id'),
	txt_ptkp_name: $('#pnl_edit-txt_ptkp_name'),
	txt_ptkp_descr: $('#pnl_edit-txt_ptkp_descr'),
	txt_ptkp_limit: $('#pnl_edit-txt_ptkp_limit'),
	chk_ptkp_isdisabled: $('#pnl_edit-chk_ptkp_isdisabled')
}
