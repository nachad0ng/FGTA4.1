...
const obj = {
	txt_provinsi_id: $('#pnl_edit-txt_provinsi_id'),
	txt_provinsi_name: $('#pnl_edit-txt_provinsi_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_provinsi_id,
		autoid: false,
		logview: 'mst_provinsi',
		btn_edit: btn_edit,
		btn_save: btn_save,
