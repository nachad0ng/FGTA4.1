...
const obj = {
	txt_kecamatan_id: $('#pnl_edit-txt_kecamatan_id'),
	txt_kecamatan_name: $('#pnl_edit-txt_kecamatan_name'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_kecamatan_id,
		autoid: false,
		logview: 'mst_kecamatan',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_kecamatan_id
