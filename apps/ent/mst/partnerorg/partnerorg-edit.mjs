...
const obj = {
	txt_partnerorg_id: $('#pnl_edit-txt_partnerorg_id'),
	txt_partnerorg_name: $('#pnl_edit-txt_partnerorg_name'),
	txt_partnerorg_descr: $('#pnl_edit-txt_partnerorg_descr'),
	chk_partnerorg_isdisabled: $('#pnl_edit-chk_partnerorg_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_partnerorg_id,
		autoid: false,
		logview: 'mst_partnerorg',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_partnerorg_id
