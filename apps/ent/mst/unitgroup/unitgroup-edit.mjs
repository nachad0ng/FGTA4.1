...
const obj = {
	txt_unitgroup_id: $('#pnl_edit-txt_unitgroup_id'),
	txt_unitgroup_name: $('#pnl_edit-txt_unitgroup_name'),
	txt_unitgroup_descr: $('#pnl_edit-txt_unitgroup_descr'),
	chk_unitgroup_isdisabled: $('#pnl_edit-chk_unitgroup_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_unitgroup_id,
		autoid: false,
		logview: 'mst_unitgroup',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_unitgroup_id
