<div id="<!--__PANELNAME__-->">
	<div class="fgta-page-title" style="display: flex; align-items: center ">
		...
		<a id="<!--__PANELNAME__-->-btn_edit" href="javascript:void(0)" class="easyui-linkbutton" style="margin-left:10px;" data-options="plain:true,iconCls:'fgta-icon-edit'">edit</a>
	</div>
...
<!--__FORMCOMP__-->
	...
	<div class="form_row" style="margin-top: 30px">
		...
		<div class="form_input_col" style="border: 0px solid black">
			...
			<div>
				<a id="<!--__PANELNAME__-->-btn_save" class="easyui-linkbutton c1" style="width: 100px">Simpan</a>
			</div>
		</div>
	</div>	
	...
	<div style="margin-top: 30px; margin-left:-5px; margin-right: -5px; background-color: #cccccc; height: 40px; display: flex; justify-content: space-between; padding: 5px 2px 2px 2px ">
		<div>
			<a id="<!--__PANELNAME__-->-btn_prev" class="easyui-linkbutton c8" style="width: 50px">Prev</a>
			<a id="<!--__PANELNAME__-->-btn_next" class="easyui-linkbutton c8" style="width: 50px">Next</a>
		</div>

		<div>
			<a id="<!--__PANELNAME__-->-btn_addnew" class="easyui-linkbutton c8" style="width: 100px">Tambah Baru</a>
		</div>
